...
// Данни за въпросите и отговорите
const faqData = [
  {
  ...
  },
  {
    ...
    answer: (
      <p>
        Всички активни сигнали са визуализирани на <Link href="/map" className="text-primary font-bold hover:underline">интерактивната карта</Link>. Червените точки показват нерешени проблеми, а зелените – разрешени. Можете да кликнете на всяка точка, за да видите повече детайли.
      </p>
    ),
  },
  {
    ...
    answer: (
      <>
        <p>
          SOFaccess е за **всеки**, който се сблъсква с предизвикателства в градската среда. Проектът е особено полезен за:
        </p>
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <ul className="list-disc list-inside pl-4 space-y-2">
          <li>
            <strong>iPhone/iPad:</strong> Отидете в Настройки {">"} Поверителност и сигурност {">"} Услуги за местоположение. Уверете се, че са включени. След това превъртете надолу до Safari и му разрешете достъп.
            <Link href="https://support.apple.com/en-gb/guide/personal-safety/ips9bf20ad2f/web" target="_blank" rel="noopener noreferrer" className="text-primary text-sm block hover:underline">Официално ръководство от Apple</Link>
          </li>
          <li>
            <strong>Android:</strong> Отворете Chrome, отидете на сайта, натиснете иконата с катинарче 🔒 вляво от URL адреса, изберете "Разрешения" и включете "Местоположение".
            <Link href="https://support.google.com/chrome/answer/142065?hl=en&co=GENIE.Platform%3DAndroid" target="_blank" rel="noopener noreferrer" className="text-primary text-sm block hover:underline">Официално ръководство от Google</Link>
          </li>
        </ul>
        <h3 className="text-lg font-semibold mt-4 mb-2">На компютър:</h3>
        <ul className="list-disc list-inside pl-4 space-y-2">
          <li><strong>Chrome:</strong> Кликнете на катинарчето 🔒 вляво от URL адреса, намерете "Местоположение" и го разрешете.
            <Link href="https://support.google.com/chrome/answer/142065?hl=en&co=GENIE.Platform%3DDesktop" target="_blank" rel="noopener noreferrer" className="text-primary text-sm block hover:underline">Официално ръководство от Google</Link>
          </li>
          <li><strong>Firefox:</strong> Кликнете на иконата вляво от URL адреса, намерете реда за "Достъп до местоположението" и премахнете временната или постоянна забрана.
            <Link href="https://support.mozilla.org/bm/questions/1260334" target="_blank" rel="noopener noreferrer" className="text-primary text-sm block hover:underline">Официален отговор от Mozilla</Link>
          </li>
    ...
    answer: (
      <p>
        Страхотно! Всяка помощ е добре дошла и ще се радваме да се включите към нашия екип. От друга страна, готови сме да отговорим на всеки въпрос. Можете да намерите имейл за контакт и повече информация за инициативата на страницата <Link href="/about" className="text-primary font-bold hover:underline">"За нас"</Link>.
      </p>
    ),
  },
];
