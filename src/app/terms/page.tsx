    ...
    <div className="bg-background">
      <div className="container mx-auto px-6 py-16 md:py-24">
        <div className="max-w-4xl mx-auto text-foreground">
          ...
          <p className="text-lg leading-relaxed mb-6">
            SOFaccess си запазва правото да променя тези Условия по всяко време. Вашето продължаващо използване на сайта след такива промени представлява Вашето съгласие с новите Условия.
          </p>
